...
export type ProfitEstimationProps = { [x: string]: any };
const defaultProps: ProfitEstimationProps = {};

export default function ProfitEstimation(props: ProfitEstimationProps) {
  const { ...rest } = props;
...
ProfitEstimation.defaultProps = defaultProps;
