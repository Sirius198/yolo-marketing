...
import Mastercard from 'src/template/components/card/Mastercard';
...
export type YourCardProps = { [x: string]: any };
const defaultProps: YourCardProps = {};
    ...
    <Card {...rest}>
          ...
          <Flex justify="center" w="100%">
            ...
            >
              <Box
                ...
                bg={
                  tabState === 'card1' ? 'brand.500' : 'secondaryGray.500'
                }
                borderRadius="50%"
              />
            </Tab>
            ...
            >
              <Box
                ...
                transition="0.1s linear"
                bg={
                  tabState === 'card2' ? 'brand.500' : 'secondaryGray.500'
                }
                borderRadius="50%"
              />
            </Tab>
            ...
            >
              <Box
                ...
                transition="0.1s linear"
                bg={
                  tabState === 'card3' ? 'brand.500' : 'secondaryGray.500'
                }
                borderRadius="50%"
              />
            </Tab>
      ...
      >
        ...
        <Text fontSize="sm" fontWeight="500" color="secondaryGray.600">
          The card number is refreshed automatically after each use. Each
          number cand be used only once.
        </Text>
      </Flex>
      <Flex mx="auto" mb="40px">
        ...
        <Flex flexDirection="column" alignItems="center">
          <IconButton
            ...
            boxShadow={shadow}
            icon={
              <Icon as={MdMoreHoriz} color={redIcon} w="24px" h="24px" />
            }
          />
          <Text fontSize="sm" fontWeight="500" color={textColor}>
            More
      ...
      <Transaction
        ...
        sum="-$34.90"
        icon={
          <Icon as={RiNetflixFill} color={redIcon} w="20px" h="18px" />
        }
      />
      <Transaction
        mb="26px"
...
YourCard.defaultProps = defaultProps;
