...
import ButtonAction from 'src/template/components/actions/ButtonAction';
import { NextChakraLink } from 'src/template/components/links/links';

export type InvoicesProps = { [x: string]: any };
const defaultProps: InvoicesProps = {};
...
export default function Invoices(props: InvoicesProps) {
  ...
  return (
    <Card flexDirection="column" w="100%" p="34px" {...rest}>
      ...
      <NextChakraLink href="https://www.orimi.com/pdf-test.pdf">
        <ButtonAction
          mb="43px"
          name="SIM16-#024215"
