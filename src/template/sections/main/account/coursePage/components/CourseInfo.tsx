...
export type CourseInfoProps = { [x: string]: any };
const defaultProps: CourseInfoProps = {};
  ...
  const panelExample = () => (
    ...
    >
      <Text fontSize="lg" color={textColorSecondary} fontWeight="400">
        ...
        recommend course. We have easy to follow step by step techniques to
        grow your followers and market your business.
      </Text>
      <Text fontSize="lg" color={textColorSecondary} fontWeight="400">
        ...
        skyrocket your brand awareness to a level beyond your expectations.
        You will have the tools to create quality content, grow your
        Instagram followers and market your business to these
                ...
                <Flex>
                  ...
                  >
                    ...
                    <Box
                      ...
                      bg={
                        tabState === 'notes' ? 'brand.500' : 'transparent'
                      }
                      mt="15px"
                      borderRadius="30px"
                    />
                  ...
                  >
                    ...
                    <Box
                      ...
                      transition="0.1s linear"
                      bg={
                        tabState === 'quiz' ? 'brand.500' : 'transparent'
                      }
                      mt="15px"
                      borderRadius="30px"
                    />
