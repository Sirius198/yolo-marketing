...
import { CircProgressMini } from 'src/template/components/charts/CircularProgress';
...
export type CompletionProps = { [x: string]: any };
const defaultProps: CompletionProps = {};

export default function CourseInfo(props: CompletionProps) {
  // Chakra Color Mode
  const textColor = useColorModeValue('secondaryGray.900', 'white');
  const brandColor = useColorModeValue('brand.500', 'brand.400');
  const bgBar = useColorModeValue('secondaryGray.100', 'whiteAlpha.100');
  const bg = useColorModeValue('secondaryGray.300', 'brandDark.700');
  ...
  return (
    <Card {...rest} maxH="max-content">
      ...
      <Flex mb="25px" alignItems="center" cursor="pointer">
        <Box w="30px" me="12px">
      ...
      <Text color={textColor} fontSize="md" fontWeight="400" mb="50px">
        ...
        followers into paying customers, how to attract 20,000 real
        followers to your account and how to convert your new Instagram
        followers to long-term loyal paying customers who love your
        business!
      </Text>
      <Text color={textColor} fontSize="xl" fontWeight="700" mb="16px">
        By the numbers
      ...
      <Text color={textColor} fontSize="xl" fontWeight="700" mb="16px">
        YoloHealth App Academy Certificate
      </Text>
      <Card bg={bg} p="18px" maxW={{ base: '400px' }}>
        <NextChakraResponsiveImage
          alt=""
          src="/assets/images/account/Diploma.png"
          borderRadius="14px"
        />
      </Card>
      <Flex
