...
export type InstructorProps = { [x: string]: any };
const defaultProps: InstructorProps = {};

export default function CourseInfo(props: InstructorProps) {
  // Chakra Color Mode
  ...
  return (
    <Card h="maxContent" {...rest} mt="50px" bg={bg}>
      ...
      <Text color={textColorSecondary} fontSize="md" mb="20px">
        Michael is an entrepreneur at heart, he builds businesses.
        Currently, he helps Fortune 100 brands leverage consumer attention
