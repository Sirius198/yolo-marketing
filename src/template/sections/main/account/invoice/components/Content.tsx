...
import tableDataInvoice from '../variables/tableDataInvoice.json';

// Assets
import { HSeparator } from 'src/template/components/separator/Separator';

export type ContentProps = { [x: string]: any };
const defaultProps: ContentProps = {};

export default function Content(props: ContentProps) {
  // Chakra Color Mode
  const textColor = useColorModeValue('secondaryGray.900', 'white');
  const bgCard = useColorModeValue('white', 'brandDark.700');
  let paid = 0;
  let total = 0;
  ...
  return (
    <Flex flexDirection="column" p={{ base: '10px', md: '60px' }}>
      <Card
      ...
      <Flex mt="70px" direction={{ base: 'column', md: 'row' }}>
        <Box me="auto" mb={{ base: '40px', md: '0px' }}>
          ...
          <Text
            ...
            maxW="292px"
          >
            Hi Anthony, please take a look at the this invoice from
            September. Let me know if you have any questions, thanks.
          </Text>
        </Box>
        <Box>
          <Flex
