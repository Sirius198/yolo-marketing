...
import Course from 'src/template/components/card/Course';
import MiniCalendar from 'src/template/components/calendar/MiniCalendar';
import Hours from './components/Hours';
import Schedule from './components/Schedule';
// Assets
import { IoLogoInstagram } from 'react-icons/io5';
import { MdOutlineUpgrade } from 'react-icons/md';
import { EthereumLogoOutline } from 'src/template/components/icons/Icons';
  ...
  let panelExample = (
    <SimpleGrid columns={1} gap="20px">
      ...
      <Course
        ...
        icon={
          <Icon as={MdOutlineUpgrade} color="white" w="100px" h="100px" />
        }
            ...
            <Flex>
              ...
              >
                ...
                <Box
                  ...
                  transition="0.1s linear"
                  bg={
                    tabState === 'upcoming' ? 'brand.500' : 'transparent'
                  }
                  mt="15px"
                  borderRadius="30px"
                />
