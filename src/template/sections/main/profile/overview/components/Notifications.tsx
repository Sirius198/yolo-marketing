...
// Custom components
import SwitchField from 'src/template/components/fields/SwitchField';
import Menu from 'src/template/components/menu/MainMenu';

export type NotificationsProps = { [x: string]: any };
...
export default function Notifications(props: NotificationsProps) {
  ...
  return (
    <Card mb="20px" {...rest}>
      <Flex alignItems="center" w="100%" justify="space-between" mb="30px">
        <Text
