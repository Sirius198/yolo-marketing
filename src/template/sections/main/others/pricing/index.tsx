...
function Pricing() {
  ...
  return (
    <PricingLayout
      image={'linear-gradient(135deg, #8dcec3 0%, #0c6d62 100%)'}
      ...
      >
        ...
        >
          ...
          >
            ...
            templates. Try now YoloHealth App
          </Text>
          <Badge
            w="max-content"
            mb="60px"
          ...
          >
            <Text
              ...
              textAlign="center"
            >
              More than 25,000 users use YoloHealth App
            </Text>
            <SimpleGrid
            ...
            >
              <NextChakraResponsiveImage
                ...
                alignSelf="center"
                justifySelf="center"
                style={{ position: 'static', objectFit: 'fill' }}
              />
              <NextChakraResponsiveImage
                alt=""
                src={'/assets/svgs/msn-logo.svg'}
                alignSelf="center"
                justifySelf="center"
                style={{ position: 'static', objectFit: 'fill' }}
              />
              <NextChakraResponsiveImage
                alt=""
                src={'/assets/svgs/microsoft-logo.svg'}
                alignSelf="center"
                justifySelf="center"
                style={{ position: 'static', objectFit: 'fill' }}
              />
              ...
              <NextChakraResponsiveImage
                alt=""
                src={'/assets/svgs/georgia-logo.svg'}
                alignSelf="center"
                justifySelf="center"
                style={{ position: 'static', objectFit: 'fill' }}
              />
              <NextChakraResponsiveImage
                alt=""
                src={'/assets/svgs/deloitte-logo.svg'}
                alignSelf="center"
                justifySelf="center"
                style={{ position: 'static', objectFit: 'fill' }}
              />
            ...
            <Box>
              <Box mb="60px">
                ...
                <Text
                  ...
                  fontSize="md"
                >
                  These products are not Wordpress themes, however, they
                  can be integrated in Wordpress by an experienced web
                  developer.
                </Text>
              </Box>
              <Box mb="60px">
              ...
              <Box mb="60px">
                ...
                <Text
                  ...
                  fontSize="md"
                >
                  It means that each theme within the Exclusive Digital
                  Bundle promotion has a thorough and up to date
                  documentation on how to get started with the product and
            ...
            <Box>
              <Box mb="60px">
                <Text
                  ...
                  mb="12px"
                >
                  Are the themes available with only classic CSS and
                  without Sass as well?
                </Text>
                <Text
                  textAlign="start"
                  color="secondaryGray.600"
              ...
              <Box mb="60px">
                ...
                <Text
                  ...
                  fontSize="md"
                >
                  In case you have already purchased a license, but you
                  want to upgrade, you can just send us a message using the
                  contact page and we will send you a discount code so you
              ...
              <Box mb="60px">
                ...
                <Text
                  ...
                  fontSize="md"
                >
                  The differences between the Free and Pro products
                  consists of the number of components, plugins, sections,
                  pages in each
                </Text>
              </Box>
            </Box>
