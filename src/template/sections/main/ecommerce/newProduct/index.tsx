...
import TagsField from 'src/template/components/fields/TagsField';
...
export default function NewProduct() {
  ...
  const productTab = useRef<any>();
  const mediaTab = useRef<any>();
  const pricingTab = useRef<any>();
          ...
          >
            <Flex
              ...
              _before={{
                ...
                height: '3px',
                bg: activeBullets.media ? 'white' : '#53b9ab',
            ...
            >
              <Box
                zIndex="1"
                border="2px solid"
                borderColor={activeBullets.product ? 'white' : '#53b9ab'}
                bg="linear-gradient(135deg, #8dcec3 0%, #0c6d62 100%)"
                w="16px"
                h="16px"
                mb="8px"
          ...
          >
            <Flex
              ...
              _before={{
                ...
                width: { sm: '120px', md: '250px', lg: '300px' },
                height: '3px',
                bg: activeBullets.pricing ? 'white' : '#53b9ab',
            ...
            >
              <Box
                zIndex="1"
                border="2px solid"
                borderColor={activeBullets.media ? 'white' : '#53b9ab'}
                bg="linear-gradient(135deg, #8dcec3 0%, #0c6d62 100%)"
                w="16px"
                h="16px"
                mb="8px"
          ...
          >
            ...
            >
              <Box
                zIndex="1"
                border="2px solid"
                borderColor={activeBullets.pricing ? 'white' : '#53b9ab'}
                bg="linear-gradient(135deg, #8dcec3 0%, #0c6d62 100%)"
                w="16px"
                h="16px"
                mb="8px"
