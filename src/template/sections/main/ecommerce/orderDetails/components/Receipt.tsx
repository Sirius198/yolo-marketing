...
export default class ComponentToPrint extends React.Component<ReceiptProps> {
  // for react-to-print to work, it must be called from a class based component

  static defaultProps = defaultProps;

  render() {
    const { bgButton, bgFocus, bgHover, handlePrint, ...rest } =
      this.props;
    ...
    return (
      ...
      >
        <Card
          backgroundImage="/assets/images/ecommerce/Details.png"
