...
import OrderStep from 'src/template/components/dataDisplay/OrderStep';
...
export type OrderStatusProps = { [x: string]: any };
const defaultProps: OrderStatusProps = {};

export default function YourOrderSteps(props: OrderStatusProps) {
  const { ...rest } = props;
  ...
  const incompleteShadow = useColorModeValue(
    ...
    'inset 0px 4px 4px #02201D'
  );
  const lineColor = useColorModeValue('%230c6d62FF', '%23FFFFFF1A');
  return (
