...
export type DropzoneCardProps = { [x: string]: any };
const defaultProps: DropzoneCardProps = {};

export default function DropzoneCard(props: DropzoneCardProps) {
  const { mb, ...rest } = props;
...
DropzoneCard.defaultProps = defaultProps;
