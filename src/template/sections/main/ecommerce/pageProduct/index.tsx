        ...
        <Flex direction={{ sm: 'column', lg: 'column', xl: 'row' }}>
          ...
          <Flex flexDirection="column">
            ...
            <Text
              ...
              mb="40px"
            >
              Just consists of a shell made of molded ash or oak veneer and
              a steel or chrome frame. The frame is mounted to the seat by
              slotting seamlessly into the millings underneath the shell.
              The chairs are stackable, up to 6 pcs. The chair is delivered
              assembled.
            </Text>
            <Text
              ...
              <AccordionItem border="none">
                ...
                <AccordionPanel p="18px 0px 10px 0px">
                  ...
                  >
                    ...
                    beautiful when seen from below as from above. The frame
                    is discretely tucked into the chair&#39;s molded shell,
                    and the shell&#39;s tapering thickness gives it a
                    friendly expression.
                  </Text>
                </AccordionPanel>
              </AccordionItem>
