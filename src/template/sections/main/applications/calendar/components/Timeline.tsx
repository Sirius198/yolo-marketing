...
import TimelineItem from 'src/template/components/dataDisplay/TimelineItem';
import React from 'react';

export type TimelineProps = { [x: string]: any };
const defaultProps: TimelineProps = {};

export default function Default(props: TimelineProps) {
  const { ...rest } = props;
  // Chakra Color Mode
