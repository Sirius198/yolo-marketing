...
export const EmailBox: React.FC<EmailBoxProps> = ({
  className,
  ...rest
}) => {
  return (
    <div
      className={`flex h-14 flex-row rounded-[32px] border-[1px] border-[#475569] p-4 pl-5 ${className}`}
      {...rest}
    >
      <input className="flex-1 outline-0" placeholder="Email address" />
