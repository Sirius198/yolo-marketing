...
const triggerOptions = [
  ...
  {
    label: 'order_attendant_allocated',
    value: 'order_attendant_allocated',
  },
  ...
  {
    label: 'payment_booking_confirmed',
    value: 'payment_booking_confirmed',
  },
  ...
  {
    label: 'payment_checkout_completed',
    value: 'payment_checkout_completed',
  },
  {
  ...
  {
    label: 'premonition_shift_created',
    value: 'premonition_shift_created',
  },
  {
    label: 'premonition_shift_updated',
    value: 'premonition_shift_updated',
  },
